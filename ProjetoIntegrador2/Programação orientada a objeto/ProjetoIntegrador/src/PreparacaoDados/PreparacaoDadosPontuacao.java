 ...
 * @author bcnet
 */
public class PreparacaoDadosPontuacao {
    ...
    public void PreencherRol(int id_jogo)
    {
        int i = 0;
        for(int q : con.buscarPontuacaoJogos(id_jogo))
        {
            this.rol.add(q);
     ...
     public void Preencherfr()
    {
       ...
       for(double fi : this.fi )
       {
           ...
           BigDecimal v = new BigDecimal(aux).setScale(2, RoundingMode.HALF_DOWN);
           
           
           this.fr.add(v.doubleValue());
           cont += 1;
       }
    ...
    public double Media()
    {
        double v = somatorioXifi() / somatoriofi();
        BigDecimal media = new BigDecimal(v).setScale(2, RoundingMode.HALF_DOWN);
